...
## 프리뷰 자막 스타일 (burn-in)
- **폰트:** Helvetica Neue Medium — **전 구간 동일 크기(30pt)**
- **스타일:** 반투명 라운드 필 + 왼쪽 노란 액센트 바 (언더라인/히어로 확대 없음)
- **파일:** `previews/shot01_09_rough.mp4` (없음: `shot01_09_rough_nosub.mp4`)

## 다음 단계
1. Premiere/DaVinci에 위 TC로 타이틀 레이어 생성  
2. VO 러프 녹음(스마트폰 OK) 후 길이만 맞춤  
3. 최종은 모션그래픽으로 교체 가능 (현 스타일을 기준)
